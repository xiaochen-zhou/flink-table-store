...
public class IsFalse extends LeafUnaryFunction {

    public static final IsFalse INSTANCE = new IsFalse();
    ...
    public Optional<LeafFunction> negate() {
        return Optional.of(IsFalse.INSTANCE);
    }

    @Override
    public <T> T visit(FunctionVisitor<T> visitor, FieldRef fieldRef, List<Object> literals) {
        return visitor.visitNotIn(fieldRef);
    }
}
