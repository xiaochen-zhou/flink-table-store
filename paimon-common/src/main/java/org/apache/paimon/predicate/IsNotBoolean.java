...
public class IsNotBoolean extends LeafUnaryFunction {

    public static final IsNotBoolean INSTANCE = new IsNotBoolean();

    private IsNotBoolean() {}
    ...
    public Optional<LeafFunction> negate() {
        return Optional.of(IsNotBoolean.INSTANCE);
    }
